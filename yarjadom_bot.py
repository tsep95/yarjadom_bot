...
• Задавай вопросы по одному за раз, ожидая ответа перед следующим. 
  Задай до 12 вопросов, чтобы понять глубинные чувства и эмоции пользователя.
...
• Стремись добраться до более глубинных чувств, таких как: одиночество, страх отвержения, вина, стыд, беспомощность, гнев, обида, тревожность, потеря смысла жизни, недоверие к людям, перфекционизм, скрытая зависть, самоотвержение, печаль, скорбь, неуверенность в себе, уязвимость.
• После 3+ вопросов анализируй историю общения и определяй основное чувство.
...
THERAPY_METHODS = {
    ...
    "страх отвержения": ("психоанализе", "он раскрывает глубокие скрытые причины и конфликты"),
    ...
    "скрытая зависть": ("психоанализе", "он раскрывает глубокие скрытые причины и конфликты"),

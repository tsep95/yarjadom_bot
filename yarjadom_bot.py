...
• Если эмоция достигла 4 совпадений, заверши диалог с этой эмоцией.
• Если после 15 вопросов нет 4 совпадений, используй эмоцию с наибольшим количеством определений.
"""

...
— Когда человек называет эмоцию, предложи профессиональное решение с указанием метода психологии (например, рефлексия, когнитивно-поведенческая терапия, осознанность).
...
# Методы психологии для предложений (mindfulness заменён на осознанность)
PSYCH_METHODS = {

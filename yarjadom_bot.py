...
def analyze_responses(history):
    ...
    # Ключевые слова и их веса для каждой причины
    keywords = {
    ...
    # Подсчёт "веса" для каждой причины
    ...
    # Выбор главной причины (или двух, если веса близки)
    ...
    # Если есть вторая причина с близким весом (разница <= 1), добавляем её
    if len(sorted_causes) > 1 and sorted_causes[0][1] - sorted_causes[1][1] <= 1:
        ...
        method, reason = THERAPY_METHODS[top_cause]  # Берем метод от главной причины

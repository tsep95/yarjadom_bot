...
• Не предлагай решений в процессе вопросов и не добавляй фразы вроде "Ты можешь остановиться" или "Продолжим позже" — 
  просто задавай вопросы, пока не достигнешь нужной глубины.
• Не генерируй заключение здесь — только вопросы или пустой ответ, когда причина ясна (после минимум 5 вопросов). 

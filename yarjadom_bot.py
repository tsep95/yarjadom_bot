...
# Константы
MIN_CONFIRMATION_QUESTIONS = 6  # Минимальное количество одинаковых эмоций для уверенности
MAX_QUESTIONS = 12  # Максимальное количество вопросов
...
• Задавай минимум 5 вопросов, продолжай до 12, если эмоция не ясна.

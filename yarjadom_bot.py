...
4. Назови метод терапии (*Психодрама*, *Гештальт-терапия* или *Когнитивно-поведенческая терапия*), объясни, почему он подходит для глубинного чувства (1-2 предложения). Добавь: «Ты можешь стать счастливее, и я верю в тебя 💛.»
...
Не упоминай терапию в первых трёх абзацах. Используй смайлики: тёплые (🤗, 💚, ☕, 🌸, 🌿, 🕊️) для поддержки, сдержанные (💔, 🌧️, 🤍, 😔, 🌙, 🥀) для грусти, подбирая под настроение.
"""

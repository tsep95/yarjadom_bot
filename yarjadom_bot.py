        ...
        if is_bot_query:
            ...
            if state["stage"] == 4:
                if not state["solution_offered"]:
                    ...
                    response = f"{solution} 🌿 Если хочешь глубже разобраться в своих чувствах с помощью {method} или других подходов, загляни к @AnotherBot — он поможет продолжить работу над твоим состоянием 😌."

...
def postprocess_final_message(text, key_moments, emotion, state):
    ...
    # Исправляем "Расширенную версию" на "расширенную версию"
    if "*Расширенную версию*" in text or "Расширенную версию" in text:
        logger.warning("Исправляем 'Расширенную версию' на 'расширенную версию'...")

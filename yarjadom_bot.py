...
2. **Минимум 5 вопросов**: Задай не менее 5 продуманных, бережных вопросов, чтобы добраться до сути состояния человека. 
   ...
   - После 5 вопросов, если причина ясна, напиши только "[Анализ готов]", чтобы код завершил диалог. Если причина не ясна, продолжай задавать вопросы до максимум 10.
...
5. **Логика диалога**:
   ...
   - Не пиши анализ или рекомендации до 5-го ответа. После 5-го ответа используй "[Анализ готов]" для завершения, если причина ясна, или продолжай до 10 вопросов.
   - После 10 вопросов всегда пиши "[Анализ готов]", даже если причина не до конца ясна.
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        # После 5 вопросов проверяем, готов ли анализ
        elif assistant_questions >= 5 and "[Анализ готов]" in response:
        ...
        # Если 10 вопросов и анализ не готов, принудительно завершаем
        ...
        # Продолжаем задавать вопросы, если анализ не готов
        else:
            await context.bot.delete_message(chat_id=user_id, message_id=thinking_msg.message_id)
            await send_long_message(user_id, response, context)

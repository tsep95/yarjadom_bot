...
Цель: углубляться в чувства через 5 вопросов. Первый вопрос уже задан: "Отлично, что ты решился начать — это уже маленький шаг к тому, чтобы стало легче! 💛 Я здесь, чтобы выслушать тебя и помочь разобраться в том, что творится внутри. Мы пойдём шаг за шагом, без спешки, чтобы ты мог почувствовать себя лучше 🌱. Что беспокоит тебя больше всего прямо сейчас? 🌿".  
...
Вопросы:  
2. "Потеря близкого — это такая глубокая рана, и я так тебе сочувствую 🤗. Когда ты впервые почувствовал, как эта грусть начала расти внутри? 🌞"  
...
"Ты так открыто поделился со мной — это большая сила, и я вижу, как много в тебе живых чувств 🤍. Опираясь на твои слова, кажется, что тебя тревожат [опиши эмоции и состояния из истории, например: 'страх одиночества, ощущение уязвимости, грусть от утраты'] 🌧️.  
...
Напиши /extended, если захочешь продолжить — я здесь, чтобы помочь тебе воспользоваться этим 🕊️."
"""
